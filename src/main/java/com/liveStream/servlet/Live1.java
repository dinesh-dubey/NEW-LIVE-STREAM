...
public class Live1 extends HttpServlet {
	...
	private final static Logger LOGGER = Logger.getLogger(Live1.class
			.getName());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    URL videoUrl = new URL("http://kalturalivestream/api_v3/?service=session&action=start&secret=e9d684a068e7ac7d99432f0a6583246e&userId=fc1e90f90de623f429208f7761c0f786&type=2&partnerId=100&expiry=345345345");
        HttpURLConnection con = (HttpURLConnection) videoUrl.openConnection();
	...
	public void getVodData(HttpServletRequest request, HttpServletResponse response,String ks) 
	{
	    ...
	    URL vodUrl = new URL("http://kalturalivestream/api_v3/?service=media&action=list&ks="+ks+"&filter:tagsLike=");
        HttpURLConnection con = (HttpURLConnection) vodUrl.openConnection();
        con.setRequestMethod("POST");
        con.setRequestProperty("Content-Type","application/x-www-form-urlencoded");
        int responseCode = con.getResponseCode();
        LOGGER.info("POST Response Code :: " + responseCode);
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) { //success
            ...
            HashMap<String,String> vodMap=null;
                    ...
                    Element root = doc.getDocumentElement();
                         ...
                         for (int temp = 0; temp < nList.getLength(); temp++) {
                             ...
                             if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                                ...
                                if(property.getProperty("TAG_NAME_FOR_ADS").equalsIgnoreCase(eElement.getElementsByTagName("tags").item(0).getTextContent()))
                                    continue;
                                vodMap.put("media_entry_URL", eElement
                                        .getElementsByTagName("dataUrl")
                                        .item(0)
                                        .getTextContent());
                                vodMap.put("media_entry_name", eElement
                                        .getElementsByTagName("name")
                                        .item(0)
                                        .getTextContent());
                                vodMap.put("media_entry_thumbnail", eElement
                                        .getElementsByTagName("thumbnailUrl")
                                        .item(0)
                                        .getTextContent());
                                vodMap.put("media_entry_duration", eElement
                                        .getElementsByTagName("duration")
                                        .item(0)
                                        .getTextContent());
                                vodMap.put("media_entryId", eElement
	    ...
	    {
	      LOGGER.error("Ohh Something went wrong to get VOD data"+e);
	    }
	}        
	...
	public void getLiveData(HttpServletRequest request, HttpServletResponse response,String ks) 
	{
	    ...
	    {
	      LOGGER.error("Ohh Something went wrong while getting live data: "+e);
	    }
	}
