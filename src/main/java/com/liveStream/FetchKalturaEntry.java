...
public class FetchKalturaEntry extends HttpServlet {
	...
	private final static Logger LOGGER = Logger.getLogger(FetchKalturaEntry.class.getName());
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			LOGGER.error("Ohh Something went wrong while getting Kaltura entry: "+e);
		}
