...
<link rel="stylesheet" type="text/css"	href="<%=request.getContextPath()%>/resources/css/lightslider.css">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/style.css">
<link href="http://fonts.googleapis.com/css?family=Raleway"	rel="stylesheet" type="text/css">
<script src="<%=request.getContextPath()%>/resources/libs/jquery.min.v3.1.1.js"></script>
<script	src="<%=request.getContextPath()%>/resources/libs/lightslider.js"></script>
...
<body class="body">
	...
	<div class="video-player-test clear" id="player">
		...
		<div id="kaltura_player_1477484934" class="player-style"
			style="height: 610px;">
			<iframe
				src="http://kalturalivestream/index.php/kwidget/cache_st/1477654856/wid/_100/uiconf_id/6709457/entry_id/0_rz76fe6t"
				height="610px" width="100%" id="live"></iframe>
		</div>
		<!-- <script>	
				kWidget.embed({
			...
			<c:forEach items="${list_vod}" var="vod_obj">
				...
				<li><a href="javascript:void(0)" class="thumbnail"
					onclick="changeMainUrl('${vod_obj['media_entryId']}', 'vod')"><img
						...
						data-description="${vod_obj['media_entry_name']} "> <small></small>
				</a>
