KALTURA_SCRIPT_NAME =  "/html5/html5lib/v1.3.3/mwEmbedLoader.php";
...
SCRIPT_LOADER_URL = 'http://kalturalivestream/html5/html5lib/v1.3.3/ResourceLoader.php';
mw.setConfig('Kaltura.UseManifestUrls', 'true');
mw.setConfig('Kaltura.ServiceUrl', 'http://kalturalivestream');
mw.setConfig('Kaltura.ServiceBase', '/api_v3/index.php?service=');
mw.setConfig('Kaltura.CdnUrl', 'http://kalturalivestream');
